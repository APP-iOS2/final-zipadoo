...
- 참여자의 위치정보와 개인정보를 같이 가져와야했던 문제
 -> https://github.com/APPSCHOOL3-iOS/final-zipadoo/issues/216<br>
  친구들의 현재 위치와 프로필이미지, 닉네임등을 같이 가져와서 하나의 뷰에 매치해서 띄워줘야 했습니다. 하지만 위치정보는 Location구조체로 저장되어있고 개인의 정보는 Location구조체 안에있는 사용자 구조체id로 저장되어있었습니다. 이를 가져올때 Location정보와 

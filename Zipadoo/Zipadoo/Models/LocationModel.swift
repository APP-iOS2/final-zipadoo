...
struct Location: Identifiable, Codable {
    ...
    var departureCoordinate: CLLocationCoordinate2D {
        return CLLocationCoordinate2D(latitude: departureLatitude ?? 0.0, longitude: departureLongitude ?? 0.0)
    }
    /// 현재 위도
    ...
    var currentCoordinate: CLLocationCoordinate2D {
        return CLLocationCoordinate2D(latitude: currentLatitude ?? 0.0, longitude: currentLongitude ?? 0.0)
    }
